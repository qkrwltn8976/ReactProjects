...
const getImageUrl = (pokemonIndex: number): string => `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${pokemonIndex}.png`
                ...
                <List>
                    {
                        data?.data.results.map((pokemon, idx) => (
                            <ListItem key={pokemon.name} onClick={() => navigate(`/${idx}`)}>
